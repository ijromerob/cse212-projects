...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: it was adding the items at the begining of the array. - PASSED
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim was not being added so this was a condition added in the GetNextPerson() method - PASSED
