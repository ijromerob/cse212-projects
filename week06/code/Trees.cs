public static class Trees
{
    ...
    private static void InsertMiddle(int[] sortedNumbers, int first, int last, BinarySearchTree bst)
    {
        ...
        {
          int halfIndex = (last + first)/2;
          bst.Insert(sortedNumbers[halfIndex]);
          // left side
          InsertMiddle(sortedNumbers,first,halfIndex-1,bst);
          // right side
          InsertMiddle(sortedNumbers,halfIndex+1,last,bst);
        }
    }
}